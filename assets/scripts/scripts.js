...
$("#top-section").append(
  '<div class="container-fluid">' +
    '<div class="row">' +
    '<div class="col-sm">' +
    "<p>“One of the best cakes experiences” - The Elixir Magazine</p>" +
    "</div>" +
    "</div>" +
    "</div>"
);
...
$("#middle-section").append(
  '         <div class="container-fluid" id="middle-section">  ' +
    ...
    '               <ul id="logo">  ' +
    '                 <a href="index.html">  ' +
    '                   <img src="assets/images/logo.png" alt="Hansel' +
    "s" +
    'Bakery Logo"' +
    "/>" +
    "                 </a>  " +
